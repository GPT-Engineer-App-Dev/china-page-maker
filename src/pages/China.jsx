    ...
    <div className="space-y-8">
      <Card>
        ...
        <CardContent>
          ...
          <AspectRatio ratio={16 / 9} className="mt-4">
            <Image src="/placeholder.svg" alt="Chinese Flag" className="object-cover rounded-md" />
          </AspectRatio>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <AspectRatio ratio={16 / 9} className="mt-4">
            <Image src="/placeholder.svg" alt="Map of China" className="object-cover rounded-md" />
          </AspectRatio>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <AspectRatio ratio={16 / 9} className="mt-4">
            <Image src="/placeholder.svg" alt="Chinese Culture" className="object-cover rounded-md" />
          </AspectRatio>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <AspectRatio ratio={16 / 9} className="mt-4">
            <Image src="/placeholder.svg" alt="Chinese Economy" className="object-cover rounded-md" />
          </AspectRatio>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <AspectRatio ratio={16 / 9} className="mt-4">
            <Image src="/placeholder.svg" alt="Tourist Attractions in China" className="object-cover rounded-md" />
          </AspectRatio>
        </CardContent>
      </Card>
    </div>
